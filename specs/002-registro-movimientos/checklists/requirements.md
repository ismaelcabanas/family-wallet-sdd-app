...
- Revisión v5 (2026-09-03, tras `/speckit.analyze`): refinamientos de consistencia. (1) FR-006: todo movimiento lleva mínimo 1 tag —si no se selecciona ninguna, el sistema asigna la tag "Sin Clasificar" (desviación deliberada del FR-004 del roadmap, documentada en Assumptions)—; (2) Escenario 2 acotado al alcance de la feature (totales por naturaleza → feature 005); (3) edge cases consolidados como referencias a los escenarios de aceptación; (4) aclaraciones de redacción en FR-001, FR-008, FR-010, FR-013 y FR-016; (5) FR ampliados a FR-001..FR-018.
