...
- Cada fila del listado muestra a la derecha **dos botones de icono**: ✏️ editar y 🗑️ eliminar (solo icono con `aria-label`; ver §5).
...
- **Título**: "Editar movimiento". Campos, orden, placeholders y mensajes de error **idénticos al alta** (FR-002; schema compartido `movement-form.schema`).
...
| Edición/eliminación de movimiento inexistente | `El movimiento ya no existe.` (toast de error + revalidación de pantalla) |
