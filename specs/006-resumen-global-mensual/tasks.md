...
- [X] T017 Ejecutar la verificación manual completa de `specs/006-resumen-global-mensual/quickstart.md` (E1–E7 + comprobación inicial + verificaciones adicionales) sobre `npm run dev` con BD migrada y sembrada
